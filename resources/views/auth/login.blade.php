                    ...
                    <form method="POST" action="{{ route('login') }}" novalidate>
                        ...
                        <div class="form-group row justify-content-center mb-0">
                            <div class="col-md-12">
                                ...
                                <p class="text-center mt-4">¿No tienes una cuenta? <a href="{{route('register')}}">Regístrate</a></p>
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link text-center btn-block" href="{{ route('password.request') }}">
